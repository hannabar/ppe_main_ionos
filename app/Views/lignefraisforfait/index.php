...
<body>
    <div class="topbar">
        ...
        <a class="button" href="/lignefraisforfait/create">Créer une ligne</a>
    </div>
            ...
            <tbody>
                <?php foreach ($lignefraisforfait as $ligne): ?>
                    <tr>
                        ...
                        <td><a href="/lignefraisforfait/<?= urlencode($ligne['IDvisiteur']) ?>/<?= urlencode($ligne['mois']) ?>/<?= urlencode($ligne['IDfraisforfait']) ?>" class="btn-voir">Voir</a></td>
                        <td><a href="/lignefraisforfait/<?= urlencode($ligne['IDvisiteur']) ?>/<?= urlencode($ligne['mois']) ?>/<?= urlencode($ligne['IDfraisforfait']) ?>/edit" class="btn-modifier">Modifier</a></td>
                        <td>
                            <form method="post" action="/lignefraisforfait/<?= urlencode($ligne['IDvisiteur']) ?>/<?= urlencode($ligne['mois']) ?>/<?= urlencode($ligne['IDfraisforfait']) ?>/delete" style="display:inline;">
