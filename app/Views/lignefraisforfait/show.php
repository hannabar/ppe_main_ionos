...
<body>
    ...
    <?php if (!empty($lignefraisforfait)): ?>
        ...
        <a class="button" href="/lignefraisforfait">⬅ Retour à la liste</a>
        <a class="button btn-modifier" href="/lignefraisforfait/<?= urlencode($lignefraisforfait['IDvisiteur']) ?>/<?= urlencode($lignefraisforfait['mois']) ?>/<?= urlencode($lignefraisforfait['IDfraisforfait']) ?>/edit">Modifier</a>
        <form method="post" action="/lignefraisforfait/<?= urlencode($lignefraisforfait['IDvisiteur']) ?>/<?= urlencode($lignefraisforfait['mois']) ?>/<?= urlencode($lignefraisforfait['IDfraisforfait']) ?>/delete" style="display:inline;">
