...
<div class="dash-main">
  ...
  <div class="dash-cards">
    <a href="<?= $base ?>/fichefrais/create" class="dash-card">
    ...
    <a href="<?= $base ?>/fichefrais" class="dash-card">
    ...
    <a href="<?= $base ?>/horforfait" class="dash-card">
    ...
    <a href="<?= $base ?>/visiteur" class="dash-card">
