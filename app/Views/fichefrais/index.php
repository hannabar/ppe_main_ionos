...
<body>
    <div class="topbar">
        ...
        <a class="button" href="/fichefrais/create">Créer une fiche frais</a>
    </div>
            ...
            <tbody>
                <?php foreach ($fichefrais as $fiche): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/fichefrais/<?= urlencode($fiche['idVisiteur']) ?>/<?= urlencode($fiche['mois']) ?>" class="btn-voir">Voir</a>
                            <a href="/fichefrais/<?= urlencode($fiche['idVisiteur']) ?>/<?= urlencode($fiche['mois']) ?>/edit" class="btn-modifier">Modifier</a>
                            <form method="post" action="/fichefrais/<?= urlencode($fiche['idVisiteur']) ?>/<?= urlencode($fiche['mois']) ?>/delete" style="display:inline;">
